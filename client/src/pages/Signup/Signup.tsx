...
const Signup = ({ renderTime }) => {
  ...
  function handleSubmit(e) {
    ...
    let exist = false;
    users.map((user) => {
      if (user.email === e.target.email.value.toLowerCase()) {
        exist = true;
      }
    });
    if (!exist) {
      ...
      <main>
        <div className={styles.container}>
          <form action="" onSubmit={(e) => handleSubmit(e)}>
            ...
            <Input inputLabel="Email" inputType="string" name="email" />
            <Input inputLabel="Name" inputType="string" name="name" />
            <Input inputLabel="Username" inputType="string" name="username" />
            <Input
              inputLabel="Password"
              inputType="password"
